def process_presets(presets):
    ...
    for preset in presets:
        ...
        single_runway_template = f"THIS IS [FACILITY] INFORMATION [ATIS_CODE] AT TIME [OBS_TIME]. RUNWAY IN USE {runway_identifier}. [TL]. [WIND]. [VIS]. [RVR]. [PRESENT_WX]. [CLOUDS]. [TEMP]. [DEW]. [PRESSURE]. [ARPT_COND]. [NOTAMS]. ACKNOWLEDGE RECEIPT OF INFORMATION [ATIS_CODE]."
        dual_runway_template = f"THIS IS [FACILITY] INFORMATION [ATIS_CODE] AT TIME [OBS_TIME]. DEPARTING RUNWAY {runway_identifier}. ARRIVING RUNWAY {runway_identifier}. [TL]. [WIND]. [VIS]. [RVR]. [PRESENT_WX]. [CLOUDS]. [TEMP]. [DEW]. [PRESSURE]. [ARPT_COND]. [NOTAMS]. ACKNOWLEDGE RECEIPT OF INFORMATION [ATIS_CODE]."
